...
lyr_OpenStreetMap_0.setVisible(true);lyr_male_cleaned_1.setVisible(true);lyr_female_cleaned_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_male_cleaned_1,lyr_female_cleaned_2];
